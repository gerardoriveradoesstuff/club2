...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Event Image</h1>
                </div>
...
$sql = "UPDATE tbl_eventos SET image='$photo' WHERE id='$mykey1'";
                                ...
                                <div class="col-lg-6">
                                    <form action="#" method="post" enctype="multipart/form-data" name="upload">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <p class="help-block">Example "Recomended Image Size in pixel 900 X 900"</p>
                                        </div>
