...
$sql = "SELECT * FROM tbl_mesas WHERE status='1' ORDER BY id DESC LIMIT $start_from, 20";
...
<?php
$sql = "SELECT COUNT(*) FROM tbl_mesas WHERE status='1'";
$result = $conn->query($sql);
...
for ($i=1; $i<=$total_pages; $i++) {
			echo "<ul class='pagination text-center'>";
    			...
    			echo "<li class='page-item'>";
      			echo "<a class='page-link' href='viewalltables.php?page=".$i."' tabindex=$i>".$i."</a>";
    			echo "</li>";
  			echo "</ul>";
